                    ...
                    <ul class="nav-menu ml-auto mr-auto" id="nav-menu-toggle">
                      ...
                      <span class="right-bar"></span></span>
                            ...
                            <ul class="drop-menu">
                                ...
                                <li class="drop-menu-item"><a href="">{{$category->category_name}}</a></li>
                                @endforeach
                            </ul>
                        ...
                        @if(Session::get('customerId'))
                            ...
                            <li class="nav-item">
                               <a href="" class="nav-link">{{Session::get('customerName')}}</a>
                           </li>
                        @else
                        <li class="nav-item">
                            <a href="{{route('blogUser.register')}}" class="nav-link">Register</a>
                        </li>
                    </ul>
                    @endif
